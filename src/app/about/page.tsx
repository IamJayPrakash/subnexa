      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <div className="flex items-center mb-4">
            <div className="mr-4 p-2 rounded-full bg-primary/10 backdrop-blur-sm">
              <Target className="h-5 w-5 text-primary" />
            </div>
            <h2 className="text-2xl font-bold">Our Story</h2>
          </div>

          <div className="ml-11 bg-background/70 backdrop-blur-md rounded-lg p-6 border border-border/50">
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              filled with ads, required sign-ups, or simply didn&apos;t work well. We wanted to
              change that.
            </p>
            <p>
        ...
        <div className="max-w-3xl mx-auto mb-16">
          ...
          <div className="ml-11 bg-background/70 backdrop-blur-md rounded-lg p-6 border border-border/50">
            <p className="mb-4">
              We believe that useful utilities and tools should be accessible to everyone,
              regardless of technical expertise or budget. Our mission is to simplify everyday
              digital tasks by providing high-quality, ad-light tools that just work.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div className="bg-background/80 backdrop-blur-sm border border-border rounded-lg p-5 hover:shadow-md transition-shadow">
          ...
          <div className="ml-11 bg-background/70 backdrop-blur-md rounded-lg p-6 border border-border/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {TEAM_MEMBERS.map((member) => (
                <div
                  key={member.name}
                  className="bg-background/80 backdrop-blur-sm border border-border rounded-lg p-6 flex flex-col hover:shadow-md transition-shadow"
                >
        ...
        <div className="max-w-3xl mx-auto mb-16">
          ...
          <div className="ml-11 bg-background/70 backdrop-blur-md rounded-lg p-6 border border-border/50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              <div className="bg-background/80 backdrop-blur-sm border border-border rounded-lg p-4 text-center hover:shadow-md transition-shadow">
            ...
            <Button asChild className="hover:shadow-md">
        ...
        {/* Contact Us */}
        <div className="max-w-3xl mx-auto bg-background/80 backdrop-blur-md border border-border/50 rounded-xl p-8 text-center shadow-lg">
