...
export default function ContactPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {/* Contact Form */}
      <div className="max-w-2xl mx-auto mb-20 bg-background border border-border rounded-xl p-8">
      ...
      <div className="max-w-4xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {CONTACT_METHODS.map((method) => (
            <div
              key={method.name}
              className="bg-background border border-border rounded-lg p-6 flex items-start space-x-4 hover:shadow-md transition-shadow"
            >
      ...
      <div className="max-w-4xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-background border border-border rounded-lg p-6 flex items-start space-x-4">
      ...
      {/* CTA */}
      <div className="max-w-3xl mx-auto bg-primary/5 border border-primary/20 rounded-xl p-8 text-center">
